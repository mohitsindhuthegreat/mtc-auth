...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background relative">
      ...
      {/* Navigation */}
      <nav className="mtc-nav fixed w-full top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <Shield className="h-8 w-8 mtc-text mr-3" />
              <span className="text-xl font-bold text-foreground">MTC Auth</span>
            </div>
      ...
      <section className="relative z-10 pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <div className="mb-8">
              <Shield className="h-16 w-16 mtc-text mx-auto mb-6" />
              <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
                Welcome back, {(user as any)?.firstName || (user as any)?.email || 'User'}
              </h1>
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
                Your MTC Auth dashboard is ready. Manage your API keys, monitor users, and secure your applications.
              </p>
              <Link href="/dashboard">
                <Button className="mtc-button px-8 py-4 text-lg">
                  Go to Dashboard
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-muted/50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="mtc-card">
              <CardHeader>
                <Zap className="h-10 w-10 mtc-text mb-4" />
            ...
            <Card className="mtc-card">
              <CardHeader>
                <Shield className="h-10 w-10 mtc-text mb-4" />
            ...
            <Card className="mtc-card">
              <CardHeader>
                <Key className="h-10 w-10 mtc-text mb-4" />
            ...
            <Card className="mtc-card">
              <CardHeader>
                <Users className="h-10 w-10 mtc-text mb-4" />
            ...
            <Card className="mtc-card">
              <CardHeader>
                <Globe className="h-10 w-10 mtc-text mb-4" />
            ...
            <Card className="mtc-card">
              <CardHeader>
                <Lock className="h-10 w-10 mtc-text mb-4" />

      ...
      <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 pt-24">
        ...
        <div className="mb-8">
          <div className="text-center">
            <Book className="h-16 w-16 mtc-text mx-auto mb-6" />
            <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Documentation
            </h1>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Complete integration guide for MTC Auth API. Learn how to implement secure authentication in your C# WinForms applications with HWID locking, version control, and blacklist management.
            </p>
          </div>
        </div>

        {/* Quick Start Guide */}
        <Card className="mtc-card mb-8">
          <CardHeader>
            <CardTitle className="flex items-center">
              <Zap className="h-5 w-5 mtc-text mr-2" />
              Quick Start Guide
            </CardTitle>
            <CardDescription>
              Get up and running with MTC Auth in 5 minutes
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="mtc-card mb-8">
          <CardHeader>
            <CardTitle className="flex items-center">
              <Code className="h-5 w-5 mtc-text mr-2" />
              API Reference
            </CardTitle>
            <CardDescription>
...
{`{
  ...
  "expires_at": "2024-12-31T23:59:59.000Z"
        ...
        <Card className="mtc-card mb-8">
          <CardHeader>
            <CardTitle className="flex items-center">
              <Users className="h-5 w-5 mtc-text mr-2" />
              Integration Examples
            </CardTitle>
            <CardDescription>
...
?>`}
        ...
        <Card className="mtc-card mb-8">
          <CardHeader>
            <CardTitle className="flex items-center">
              <Shield className="h-5 w-5 mtc-text mr-2" />
              Advanced Features
            </CardTitle>
            <CardDescription>
...
// - Application-specific: Only affects your application`}
        ...
        <Card className="mtc-card">
          <CardHeader>
            <CardTitle className="flex items-center">
              <Lock className="h-5 w-5 mtc-text mr-2" />
              Security Best Practices
            </CardTitle>
            <CardDescription>
              Important security considerations when using MTC Auth
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">

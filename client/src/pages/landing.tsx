  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className={`relative z-10 transition-all duration-1000 ${showContent ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        {/* Navigation */}
        <nav className="mtc-nav fixed w-full top-0 z-50 backdrop-blur-md bg-background/80 border-b border-border/50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              <div className="flex items-center">
                <Shield className="h-8 w-8 mtc-text mr-3" />
                <span className="text-2xl font-bold text-foreground">MTC Auth</span>
              </div>
              <div className="flex items-center space-x-4">
                ...
                <Button 
                  onClick={handleLogin}
                  className="mtc-button px-6 py-2"
                >
                  Sign In
                </Button>
              </div>
            ...
            <div className="mb-8">
              <div className="relative inline-block mb-6">
                <div className="absolute inset-0 animate-ping">
                  <Shield className="h-16 w-16 mtc-text opacity-30" />
                </div>
                <Shield className="h-16 w-16 mtc-text animate-float gpu-accelerated" />
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-delay-2">
                <Button 
                  onClick={handleLogin}
                  className="mtc-button px-8 py-4 text-lg gpu-accelerated group relative overflow-hidden"
                >
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-muted/30 backdrop-blur-sm">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="mtc-card gpu-accelerated group relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-primary/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                <CardHeader className="relative z-10">
                  <div className="relative">
                    <Zap className="h-10 w-10 mtc-text mb-4 group-hover:animate-smooth-bounce transition-all duration-300" />
              ...
              <Card className="mtc-card gpu-accelerated group relative overflow-hidden">
                ...
                <CardHeader className="relative z-10">
                  <div className="relative">
                    <Shield className="h-10 w-10 mtc-text mb-4 group-hover:animate-smooth-bounce transition-all duration-300" />
                    <div className="absolute inset-0 bg-primary/20 rounded-full blur-lg opacity-0 group-hover:opacity-50 transition-opacity duration-300"></div>
                  </div>
              ...
              <Card className="mtc-card gpu-accelerated group relative overflow-hidden">
                ...
                <CardHeader className="relative z-10">
                  <div className="relative">
                    <Key className="h-10 w-10 mtc-text mb-4 group-hover:animate-smooth-bounce transition-all duration-300" />
                    <div className="absolute inset-0 bg-primary/20 rounded-full blur-lg opacity-0 group-hover:opacity-50 transition-opacity duration-300"></div>
                  </div>
              ...
              <Card className="mtc-card gpu-accelerated group relative overflow-hidden">
                ...
                <CardHeader className="relative z-10">
                  <div className="relative">
                    <Users className="h-10 w-10 mtc-text mb-4 group-hover:animate-smooth-bounce transition-all duration-300" />
                    <div className="absolute inset-0 bg-primary/20 rounded-full blur-lg opacity-0 group-hover:opacity-50 transition-opacity duration-300"></div>
                  </div>
              ...
              <Card className="mtc-card gpu-accelerated group relative overflow-hidden">
                ...
                <CardHeader className="relative z-10">
                  <div className="relative">
                    <Globe className="h-10 w-10 mtc-text mb-4 group-hover:animate-smooth-bounce transition-all duration-300" />
                    <div className="absolute inset-0 bg-primary/20 rounded-full blur-lg opacity-0 group-hover:opacity-50 transition-opacity duration-300"></div>
                  </div>
              ...
              <Card className="mtc-card gpu-accelerated group relative overflow-hidden">
                ...
                <CardHeader className="relative z-10">
                  <div className="relative">
                    <Lock className="h-10 w-10 mtc-text mb-4 group-hover:animate-smooth-bounce transition-all duration-300" />
                    <div className="absolute inset-0 bg-primary/20 rounded-full blur-lg opacity-0 group-hover:opacity-50 transition-opacity duration-300"></div>
                  </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="text-4xl md:text-5xl font-bold mtc-text mb-2 animate-pulse">99.9%</div>
                <div className="text-lg text-muted-foreground">Uptime Guarantee</div>
              </div>
              <div className="text-center">
                <div className="text-4xl md:text-5xl font-bold mtc-text mb-2 animate-pulse">&lt;50ms</div>
                <div className="text-lg text-muted-foreground">Average Response</div>
              </div>
              <div className="text-center">
                <div className="text-4xl md:text-5xl font-bold mtc-text mb-2 animate-pulse">24/7</div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground mb-12">
                Join thousands of developers who trust MTC Auth for their authentication needs
              </p>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {featureCategories.map((category, index) => (
                <Card key={index} className="mtc-card hover:scale-105 transition-all duration-300">
                  <CardHeader className="pb-4">
                    <div className="flex items-center gap-3 mb-3">
                      <div className="mtc-text">{category.icon}</div>
                    ...
                    <ul className="space-y-3">
                      {category.features.map((feature, featureIndex) => (
                        <li key={featureIndex} className="flex items-start gap-3 text-sm">
                          <CheckCircle className="h-4 w-4 mtc-text mt-0.5 flex-shrink-0" />
            ...
            <div className="text-center mt-12">
              <Button 
                onClick={handleLogin}
                className="mtc-button px-8 py-4 text-lg hover:scale-105 transition-transform"
              >
                Start Building Now
              </Button>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="flex items-center mb-4 md:mb-0">
                <Shield className="h-6 w-6 mtc-text mr-2" />
                <span className="text-lg font-semibold text-foreground">MTC Auth</span>
              </div>
              <div className="text-sm text-muted-foreground">
                © 2024 MTC Auth. All rights reserved.
              </div>
            </div>
          </div>
        </footer>
